...
class ImagePickerActivity : AppCompatActivity() {
    ...
    private var bitmapMaxHeight = 1500
    private val IMAGE_COMPRESSION = 100
...
// applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.color_red))
    ...
    companion object {
        ...
        fun showImagePickerOptions(context: FragmentActivity?, listener: PickerOptionListener) { // setup the alert builder
